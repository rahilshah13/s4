Here is the updated header file (`s4.h`) and the corresponding documentation extensions incorporating full Git server and Git repository-as-a-bucket capabilities via Smart HTTP protocols.

---

### Updated Header File (`s4.h`)
